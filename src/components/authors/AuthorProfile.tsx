    ...
    <header className="mb-16">
      <div className="flex flex-col lg:flex-row gap-12 items-start">
        ...
        <div className="flex-shrink-0">
          <div className="w-40 h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden bg-gradient-to-br from-yellow-400 to-yellow-500 relative">
            {author.profileImage ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-6xl lg:text-7xl font-black text-black">
        ...
        <div className="flex-1">
          {/* Role badge */}
          <span className="inline-block px-4 py-2 bg-yellow-400 text-black text-sm font-bold uppercase tracking-wider mb-4">
          ...
          {/* Title */}
          {author.title && (
            <p className="text-xl text-yellow-400/80 mb-6">
              {author.title}
            </p>
          )}
            ...
            <div className="flex gap-8">
              ...
              {author.joinDate && (
                <div>
                  ...
                  <span className="text-white text-sm ml-2">{formatDate(author.joinDate, 'long')}</span>
                </div>
              )}
            </div>
